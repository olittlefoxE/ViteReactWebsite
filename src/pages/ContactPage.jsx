      ...
      <div className="mt-10 w-full max-w-lg rounded-lg border border-forgeGrayWarm bg-gradient-to-tl from-emberSpark via-emberHeat to-forgeGrayDark p-8 text-forgeGrayAsh shadow-xl dark:border-forgeGrayDeep dark:text-forgeGrayLight">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <a
            ...
            className="flex transform items-center space-x-4 rounded-lg bg-gradient-to-tl from-forgeAsh via-forgeSmoke via-40% to-fireAccent to-70% p-4 shadow-lg transition hover:scale-105"
          >
            <svg
            ...
            <span className="text-lg font-semibold">littlefoxE's YouTube</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex transform items-center space-x-4 rounded-lg bg-gradient-to-br from-forgeDark via-forgeAsh to-forgeSmoke p-4 shadow-lg transition hover:scale-105"
          >
            <svg
              className="max-h-8 max-w-8"
              fill="currentColor"
            ...
            <span className="text-lg font-semibold">olittlefoxE's GitHub</span>
          </a>
